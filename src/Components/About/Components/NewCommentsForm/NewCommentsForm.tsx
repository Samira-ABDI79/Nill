...
<p className="font-normal mt-12  text-xl text-white text-center mb-6" dir="rtl">ثبت نظر</p>
...
<textarea name="" id="" className="bg-dark text-white mt-10" placeholder="نظر خود را بنویسید ..."></textarea>
    </div>
