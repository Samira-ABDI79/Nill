...
function NotFound(){
    return (
      ...
      <div className=" flex justify-center items-center mt-12 pb-20 bg-white">
  <div className="w-3/6 flex flex-col justify-center items-center bg-white">
...
صفحه مورد نظر یافت نشد !
  ...
  <p className="mt-12 font-bold text-white " dir="rtl">
